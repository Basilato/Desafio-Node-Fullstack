  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        category: {
          futebol: 'hsl(var(--cat-futebol))',
          show: 'hsl(var(--cat-show))',
          teatro: 'hsl(var(--cat-teatro))',
          festival: 'hsl(var(--cat-festival))',
          esporte: 'hsl(var(--cat-esporte))',
          outro: 'hsl(var(--cat-outro))',
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      boxShadow: {
        soft: '0 4px 24px -4px hsl(var(--background) / 0.2)',
        glow: '0 0 0 1px hsl(var(--ring) / 0.2), 0 12px 32px -12px hsl(var(--primary) / 0.35)',
      },
      keyframes: {
        'fade-in': {
          '0%': { opacity: '0' },
